...
func EditUser(w http.ResponseWriter, r *http.Request) {
	...
	params := (&auth.UserToUpdate{}). //add to firebase auth
						DisplayName(eui.Name)

	u, err := authClient.UpdateUser(ctx, eui.Uid, params)
	if err != nil {
